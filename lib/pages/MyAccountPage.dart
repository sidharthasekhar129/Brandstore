...
import 'package:brandstorex/pages/AddressPage.dart';
import 'package:brandstorex/pages/ChangePasswordPage.dart';
import 'package:brandstorex/pages/MyOrdersPage.dart';
import 'package:brandstorex/pages/MyPointsPage.dart';
          ...
          child:  Column(
            children: <Widget>[
             // maincard2(username),
                                ...
                                children: <Widget>[
                                  ...
                                  GestureDetector(
                                    ...
                                    child: Container(
                                      width: 60,
                                      alignment: Alignment.center,
                                      child:  Text("total\n"+userDocument["length"].toString(),textAlign: TextAlign.center,style: TextStyle(
                            ...
                            builder: (context, snapshot) {
                              ...
                              return  Row(
                                children: <Widget>[
                                  GestureDetector(
                                    onTap: (){
                                      Navigator.of(context).push(MaterialPageRoute(builder: (context) => MyCartPage(username: username,)));
              ...
              GestureDetector(
                onTap: (){
                  Navigator.of(context).push(MaterialPageRoute(builder: (context) => SharePage(username: username,)));
                },
                child:   Share(),
              ),
